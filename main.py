...
def inference_likelihood(traindata,class_labels,n_classes,n_features): #Multivariate Gaussian + MLE estimation
    ...
    for i in range(n_classes):
        ...
        var_array = np.cov(data_ci.T);
        all_class_var[i] = var_array;
